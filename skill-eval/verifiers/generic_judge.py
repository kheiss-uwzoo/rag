...
def locate_trajectory() -> str | None:
    # Under LocalEnvironment the trajectory lives in a per-session workdir
    # (not /logs/...). LocalEnvironment.exec() exports DFW_TRAJECTORY_FILE
    # pointing at the actual file; check it before the hard-coded candidates.
    override = os.environ.get("DFW_TRAJECTORY_FILE")
